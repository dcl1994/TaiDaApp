 ...
 * 饮食文化
 */
public class CookingCultureActivity extends Activity {

    @Bind(R.id.back)
    ImageView back;
    @Bind(R.id.title_view)
    TextView titleView;
    @Bind(R.id.CookingCurture_recycler)
    RecyclerView CookingCurtureRecycler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CookingCurtureRecycler.setLayoutManager(manager);
     ...
     * 获取饮食文化
     */
    private void doCookingCulture() {
        OkHttpUtil.sendOkHttpRequest(Url.CookingCulture, new Callback() {
            @Override
                    ...
                    public void run() {
                        try {
                            ...
                            if (flag == true) {
                                ...
                                CookingCurtureRecycler.setAdapter(adapter);
                                /**
                                 * dialog过一秒隐藏
                                 */
