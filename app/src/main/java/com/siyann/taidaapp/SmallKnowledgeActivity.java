 ...
 * 养身小知识
 */
public class SmallKnowledgeActivity extends Activity {

    @Bind(R.id.back)
    ImageView back;
    @Bind(R.id.title_view)
    TextView titleView;
    @Bind(R.id.small_knowledge_recycler)
    RecyclerView smallKnowledgeRecycler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_small_knowledge);
        ...
        smallKnowledgeRecycler.setLayoutManager(manager);
     ...
     * 获取养身小知识
     */
    private void dosmallknowledge() {
        OkHttpUtil.sendOkHttpRequest(Url.SmallKnowledge, new Callback() {
            @Override
                            ...
                            if (flag == true) {
                                ...
                                new CountDownTimer(600, 100) {
                                    ...
                                    public void onFinish() {
                                        ...
                                        smallKnowledgeRecycler.setAdapter(adapter);
                                        dialog.dismissWithAnimation();
                                    }
                                }.start();
                            } else {
